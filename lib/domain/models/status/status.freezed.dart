...
abstract class $StatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String status, int count});
}
...
class _$_Status implements _Status {
  const _$_Status(
      {required this.id, required this.status, required this.count});
  ...
  @override
  String toString() {
    return 'Status(id: $id, status: $status, count: $count)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, status, count);
...
abstract class _Status implements Status {
  const factory _Status(
      ...
      required final int count}) = _$_Status;
