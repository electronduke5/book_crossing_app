...
abstract class $StatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String surname, int name});
}
...
class _$_Status implements _Status {
  const _$_Status(
      {required this.id, required this.surname, required this.name});
  ...
  @override
  String toString() {
    return 'Status(id: $id, surname: $surname, name: $name)';
  }
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, surname, name);
...
abstract class _Status implements Status {
  const factory _Status(
      ...
      required final int name}) = _$_Status;
