...
part of '../../../data/models/genre.dart';
...
abstract class $GenreCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, String genreName});
}
...
class _$_Genre implements _Genre {
  const _$_Genre({required this.id, required this.genreName});
  ...
  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, genreName);
...
abstract class _Genre implements Genre {
  const factory _Genre(
      {required final int id, required final String genreName}) = _$_Genre;
