...
class _$_Review implements _Review {
  ...
  List<User> get likedUser {
    ...
    return EqualUnmodifiableListView(_likedUser);
  }
  ...
  @override
  String toString() {
    return 'Review(id: $id, title: $title, text: $text, user: $user, book: $book, likedUser: $likedUser, likesCount: $likesCount)';
  }
  ...
  int get hashCode => Object.hash(runtimeType, id, title, text, user, book,
      const DeepCollectionEquality().hash(_likedUser), likesCount);
...
abstract class _Review implements Review {
  const factory _Review(
      ...
      required final List<User> likedUser,
      required final int likesCount}) = _$_Review;
